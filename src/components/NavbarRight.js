        ...
        <div style={{ height: '100%', display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
            {userloggedIn ?
                <>
                    ...
                    <span onClick={logout} style={{ borderRadius: '50%', backgroundImage: `url(${userImg})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center center', height: '30px', width: '30px', marginRight: '20px' }}></span>
                </>
                :
